...
?>
    <main id="cart">
        <div class="container bg-white mt-5 mb-5 p-2 rounded">
                ...
                <div class="col-lg-4 mt-5 ">
                    ...
                    <div class="mb-3 position-relative pb-1 af-b-line">
                        ...
                        <?php if((isset($_GET['situ']) && $_GET['situ']=="false") || !isset($_GET['situ'])){?>
                            ...
                            <div class="d-flex justify-content-between mb-3">
                                <p class="m-0 fw-bold">Shipping: <?= $arrShipping['id'] == 4 ? "Cash on delivery": ""?>:</p>
                    ...
                    ?>
                    <a href="<?=base_url()."/checkout/".$urlCupon?>" class="mb-3 w-100 btn btn-bg-1">Checkout</a>
                    <?php }else{ ?>
                    <button type="button" onclick="openLoginModal();" class="mb-3 w-100 btn btn-bg-1">Checkout</button>
                    <?php }?>
                    <a href="<?=base_url()?>/shop/" class="w-100 btn btn-bg-2">Keep buying</a>
                </div>
            </div>
            <?php }else {?>
                <div class="d-flex justify-content-center align-items-center p-5 text-center">
                    <div>
                        ...
                        <a href="<?=base_url()?>/shop/" class="btn btn-bg-1">Go shopping</a>
                    </div>
                </div>
            <?php }?>
        </div>
