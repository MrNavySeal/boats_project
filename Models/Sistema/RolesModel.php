    ...
    class RolesModel extends Mysql{
        ...
        public function selectPermisos($intId){
            ...
            foreach ($arrModules as &$module) {
                $module['nickname'] = str_replace(" ","",$module['name']);
                ...
                foreach ($arrSections as &$section) {
                    $section['nickname'] = str_replace(" ","",$section['name']);
                    ...
                    foreach ($arrOptionsSection as &$optionSection) {
                        $optionSection['nickname'] = str_replace(" ","",$optionSection['name']);
                ...
                foreach ($arrOptions as &$option) {
                    $option['nickname'] = str_replace(" ","",$option['name']);
