<?php
    ...
    trait CustomerTrait{
        ...
        public function setCustomerT($strName,$strPicture,$strEmail,$strPassword,$rolid,$strPhone =""){
            $this->con = new Mysql();
            ...
            if(empty($request)){
                $query = "INSERT INTO person(firstname,image,email,countryid,stateid,cityid,password,roleid,phone) VALUE(?,?,?,?,?,?,?,?,?)";
                $arrData = array(
                    $this->strNombre,
                    $this->strPicture,
                    $this->strEmail,
