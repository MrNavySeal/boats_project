                    ...
                    if(empty($_POST['nombre'])){
                        ...
                        if($intId == 0){
                            if($_SESSION['permitsModule']['w']){
                                ...
                                $request= $this->model->insertServicio($strNombre,$strDescripcion,$strDescripcionCorta,$intEstado,$strRuta,$strImagenNombre);
                            }
                        }else{
                            if($_SESSION['permitsModule']['u']){
                                ...
                                $request = $this->model->updateServicio($intId,$strNombre,$strDescripcion,$strDescripcionCorta,$intEstado,$strRuta,$strImagenNombre);
                            }
                        }
                        if($request > 0 ){
